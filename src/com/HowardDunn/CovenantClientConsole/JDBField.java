 ...
 * <p>Description: è¿™ä¸ªç±»ç”¨äºŽè¡¨ç¤ºDBFæ–‡ä»¶ä¸­çš„å­—æ®µ</p>
...
public class JDBField {
   ...
   * æž„é€ å‡½æ•°
   * @param s å­—æ®µå��
   * @param c å­—æ®µç±»åž‹ï¼Œä½¿ç”¨ä¸€ä¸ªå­—ç¬¦æ�¥æ��è¿°
   *   'C' å­—ç¬¦ä¸²ç±»åž‹
   *   'N' æ•°å€¼ç±»åž‹
   *   'D'
   *   'F' æµ®ç‚¹ç±»åž‹
   * @param i é•¿åº¦
   * @param j å°�æ•°ä½�æ•°
   * @throws JDBFException å¦‚æžœä¸Žå­—æ®µç±»åž‹å®šä¹‰ä¸�å�ˆï¼Œåˆ™ä¼šæŠ›å‡ºå¼‚å¸¸
   */
